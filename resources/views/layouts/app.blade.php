...
<html lang="en">
  ...
  <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
      ...
      <div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
        <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('{{asset('dist/assets/media/bg/bg-11.jpg')}}');">
          <div class="login-form p-7 position-relative overflow-hidden">
            <!--begin::Login Header-->
            <div class="d-flex flex-center text-center mb-5">
              <a href="#">
                <img src="{{asset('images/trust-logo.png')}}" height="80px" class="mr-3" alt="logo" /><br>
              </a>
            </div>
            @yield('content')
          </div>
    ...
    <script type="text/javascript">
      function _callPasswordShow(type){
        var input = $('#' + type);
        $('.toggle-' + type).toggleClass("fa-eye-slash");
