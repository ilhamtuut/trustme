...
@section('breadcrumb')
  ...
  <li class="breadcrumb-item">
      <a href="" class="text-white text-hover-dark">Profile</a>
  </li>
@endsection
      ...
      <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
        ...
        <li class="nav-item mr-3">
          <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_2">
            ...
            <span class="nav-text font-size-lg">Change Login Password</span>
          </a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
        <li class="nav-item mr-3">
          <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_3">
            ...
            <span class="nav-text font-size-lg">Change Security Password</span>
          </a>
        </li>
        <!--end::Item-->
      </ul>
  ...
  <div class="card-body px-0">
      <div class="tab-content">
          ...
          <div class="row">
            ...
            <div class="col-xl-7 my-2">
              ...
              <div class="form-group row">
                <label class="col-form-label col-3 text-lg-right text-left">Sponsor Name</label>
                <div class="col-9">
                  <div class="input-group input-group-lg input-group-solid">
                    <div class="input-group-prepend">
                      ...
                      <input class="form-control form-control-lg form-control-solid" type="text" value="{{ucfirst(Auth::user()->parent->username)}}" readonly>
                    </div>
                </div>
              </div>
              @endif
              ...
              <!--begin::Group-->
              <div class="form-group row">
                <label class="col-form-label col-3 text-lg-right text-left">Link Referral</label>
                <div class="col-9">
                  <div class="input-group input-group-lg input-group-solid">
                    <div class="input-group-prepend">
                      <span class="input-group-text">
                    ...
                    <input id="referal" type="text" class="form-control form-control-lg form-control-solid" value="{{route('referal', Auth::user()->username )}}" readonly>
                    <div class="input-group-prepend" style="cursor: pointer;" onclick="copyReferal()">
                      <span class="input-group-text">
              ...
              <div class="row">
                ...
                <div class="col-xl-7">
                  ...
                  <div class="row">
                    <label class="col-3"></label>
                    <div class="col-9">
                      <h6 class="text-dark font-weight-bold mb-10">Change Or Recover Your Login Password:</h6>
                    </div>
                  </div>
                  <!--end::Row-->
                    <!--begin::Group-->
              ...
              <div class="row">
                ...
                <div class="col-xl-7">
                  <div class="row">
                    <div class="col-4"></div>
                    <div class="col-8">
                      <button type="submit" class="btn btn-light-success font-weight-bold">Save changes</button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="tab-pane px-7" id="kt_user_edit_tab_3" role="tabpanel">
          <!--begin::Body-->
          <form action="{{route('user.updatePasswordtrx')}}" method="POST">
            @csrf
            <div class="card-body">
              <!--begin::Row-->
              <div class="row">
                ...
                <div class="col-xl-7">
                  ...
                  <div class="row">
                    <label class="col-3"></label>
                    <div class="col-9">
                      <h6 class="text-dark font-weight-bold mb-10">Change Or Recover Your Security Password:</h6>
                    </div>
                  </div>
                  <!--end::Row-->
