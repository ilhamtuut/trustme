@extends('layouts.backend',['active'=>$active,'page'=>'program','type'=>'bonus'])
...
@section('breadcrumb')
  ...
  <li class="breadcrumb-item">
      <a href="" class="text-white text-hover-dark">Bonus {{ucfirst($type)}}</a>
  </li>
@endsection
                ...
                <div class="col-lg-12 col-xl-12">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 my-2 my-md-0">
                            <form action="{{ route('program.bonus_active',$type) }}" method="get" id="form-search">
                    ...
                    @if($data->count()>0)
                      @foreach ($data as $h)
                        <tr>
                          ...
                          <td>{{$h->description}} @if($type == 'sponsor') from {{ucfirst($h->from->username)}} @endif</td>
                          @if($type != 'weekly')
