@extends('layouts.backend',['active'=>'register_wallet','page'=>'wallet'])
...
@section('breadcrumb')
  ...
  <li class="breadcrumb-item">
      <a href="" class="text-white text-hover-dark">Register Wallet</a>
  </li>
@endsection
...
<div class="col bg-success px-6 py-3 rounded-sm mb-5">
    ...
    <span href="#" class="text-white font-weight-bold font-size-h6">Register Wallet <br><i class="fas fa-dollar-sign text-white"></i> {{number_format($saldo,2)}}</span>
    @if(is_null($id))
        <p class="pt-5">
            <a href="{{route('transfer.wallet','register_wallet')}}" class="btn btn-light-success mr-3"><i class="far fa-share-square"></i>Transfer</a>
        </p>
    @else
        ...
        <div class="mb-7">
            <div class="row align-items-center">
                <div class="col-lg-12 col-xl-12">
                      @if($id)
                        <form action="{{ route('balance.register_member',$id) }}" method="get">
                      @else
                        <form action="{{ route('balance.register') }}" method="get">
                      @endif
                      <div class="row align-items-center">
